        ...
        return MediaEvent.newBuilder()
                ...
                .setDataBuilder(
                        MediaData.newBuilder()
                                ...
                                .setPriority(mediaSnapshot.getPriority().getPriority())
                                .setExtension(mediaSnapshot.getMediaFile().getExtension().name())
                                .setFilename(mediaSnapshot.getMediaFile().getFilename())
                                .setFileUrl(mediaSnapshot.getMediaFile().getFileUrl().toString())
                                .setFileHash(mediaSnapshot.getMediaFile().getFileHash())
                                .setThumbnailUrl(mediaSnapshot.getMediaFile().getThumbnailUrl().toString())
                                .setStatus(mediaSnapshot.getMediaFile().getStatus().name())
